...
export const products: Product[] = [
  ...
  {
    "id": 39,
    "name": "Harem Pants Adjusted For Men Hip-Hop Style Shots Little Feet Trousers Fashion Brand Fashion Brand Best Sellers",
    "price": 237000,
  ...
  {
    "id": 40,
    "name": "(full Black)Men's Sports Shoes Springtime New Casual Fashion Round Toe Lightweight Best Sellers ",
    "price": 62000,
